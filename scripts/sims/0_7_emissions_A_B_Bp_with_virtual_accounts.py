...
def multi_claim_sim():
  ...
  for epoch in range(number_of_epochs):
    ...
    for user in range(number_of_users):      
      ...
      current_virtual_reward_earned, current_virtual_reward_dust = process_virtual_account_emissions(
      ...
      claimed_points = user_total_rewards_fair * SECONDS_PER_EPOCH + current_virtual_reward_earned * SECONDS_PER_EPOCH + current_epoch_emissions_earned * SECONDS_PER_EPOCH
...
def process_virtual_account_emissions(user_rewards, total_points_b, emissions_b_b, emissions_b_b_points_cumulative_per_epoch, epoch):
  """
...
def process_emissions_for_epoch(b_rewards_eligible_for_emissions, total_points_b, emissions_b_b, emissions_b_b_points_cumulative_per_epoch, epoch):
  """
