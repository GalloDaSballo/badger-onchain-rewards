...
def test_claimBulkTokensOverMultipleEpochsOptimizedWithoutStorageNonEmitting_basic(initialized_contract, user, fake_vault, token):
  ...
  tx = initialized_contract.claimBulkTokensOverMultipleEpochsOptimizedWithoutStorageNonEmitting([EPOCH, EPOCH, fake_vault, [token]], {"from": user})
...
def test_claimBulkTokensOverMultipleEpochsOptimizedWithoutStorageNonEmitting_cannotClaimForOthers(initialized_contract, user, fake_vault, token, second_user):
  ...
  """
  tx = initialized_contract.claimBulkTokensOverMultipleEpochsOptimizedWithoutStorageNonEmitting([EPOCH, EPOCH, fake_vault, [token]], {"from": second_user})
...
def test_claimBulkTokensOverMultipleEpochsOptimizedWithoutStorageNonEmitting_permissions(initialized_contract, user, fake_vault, token, second_user):
  ...
  with brownie.reverts("dev: epoch math wrong"):
    initialized_contract.claimBulkTokensOverMultipleEpochsOptimizedWithoutStorageNonEmitting([EPOCH, CURRENT_EPOCH, fake_vault, [token]], {"from": user})
  ...
  with brownie.reverts("dev: You already accrued during the epoch, cannot optimize"):
    initialized_contract.claimBulkTokensOverMultipleEpochsOptimizedWithoutStorageNonEmitting([CURRENT_EPOCH, CURRENT_EPOCH, fake_vault, [token]], {"from": user})
...
def test_claimBulkTokensOverMultipleEpochsOptimizedWithoutStorageNonEmitting_cannot_use_old_balance(initialized_contract, user, fake_vault, token, second_user):
  ...
  initialized_contract.claimBulkTokensOverMultipleEpochsOptimizedWithoutStorageNonEmitting([2, 3, fake_vault, [token]], {"from": user})
  initialized_contract.claimBulkTokensOverMultipleEpochsOptimizedWithoutStorageNonEmitting([2, 3, fake_vault, [token]], {"from": second_user})
...
def test_bulk_claim_no_points(initialized_contract, user, fake_vault, token, second_user):
  ...
  initialized_contract.claimBulkTokensOverMultipleEpochsOptimizedWithoutStorageNonEmitting([1, 1, fake_vault, [token]], {"from": user})
...
def test_bulk_claim_revert(initialized_contract, user, fake_vault, token, second_user):
  ...
  with brownie.reverts():
    initialized_contract.claimBulkTokensOverMultipleEpochsOptimizedWithoutStorageNonEmitting([1, 0, fake_vault, [token]], {"from": user})
  ...
  with brownie.reverts():
    initialized_contract.claimBulkTokensOverMultipleEpochsOptimizedWithoutStorageNonEmitting([1, 1, fake_vault, [token, token]], {"from": user})
